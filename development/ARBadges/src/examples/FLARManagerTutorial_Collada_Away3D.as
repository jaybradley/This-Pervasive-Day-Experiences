package examples {
	...
	public class FLARManagerTutorial_Collada_Away3D extends Sprite {
		...
		[Embed(source="../resources/assets/models/model.dae",mimeType="application/octet-stream")]
		...
		private function onFlarManagerInited (evt:Event) :void {
			...
			model.materialLibrary.mtlLoadRequired = true;
			model.materialLibrary.textureLoadRequired = true;
